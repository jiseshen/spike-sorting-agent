...
Usage: uv run python scripts/run/run_single_channel.py CH3
       uv run python scripts/run/run_single_channel.py CH20
       uv run python scripts/run/run_single_channel.py CH30
       uv run python scripts/run/run_single_channel.py CH31
"""
...
if len(sys.argv) < 2:
    ...
    print("Usage: uv run python scripts/run/run_single_channel.py CH3")
    print("       uv run python scripts/run/run_single_channel.py CH20")
    print("       uv run python scripts/run/run_single_channel.py CH30")
    print("       uv run python scripts/run/run_single_channel.py CH31")
    sys.exit(1)
