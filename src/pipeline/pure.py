...
No heuristic rules - VLM judges everything with neuronal context.
...
from ..cluster.features import ClusterFeatures
from ..cluster.auto_filter import automatic_size_filter
