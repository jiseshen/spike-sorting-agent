...
from src.vlm_curation_pipeline_ablation import PureVLMCurationPipeline
...
if __name__ == '__main__':
    ...
    print("-"*80)
    print("Run `uv run aggregate_results.py --base-dir output/ablation_no_metrics` to compute cross-channel summaries when desired.")
    if channel_stats:
    ...
    print("Next: aggregate with `uv run aggregate_results.py --base-dir output/ablation_no_metrics` if needed.")
    print("="*80)
